...
public:
    WeightProduct(const ProductInfo &info, double cost) noexcept: Product(info), m_cost_per_kg(cost) {}

    WeightProduct(const WeightProduct &w_p) noexcept: Product(w_p.m_product_info), m_cost_per_kg(w_p.m_cost_per_kg) {}
